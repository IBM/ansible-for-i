...
ibmi_display_fix -- Displays the PTF(Program Temporary Fix) information and also get the requisite information for the PTF
==========================================================================================================================
...
Synopsis
--------
- The ``ibmi_display_fix`` module displays the information of the PTF and also get the requisite PTFs and their type.
...
-------------
       ...
       requisite_ptf
        | The requisite PTFs and their type.
