...
version_added: '2.8.0'
description:
     - The C(ibmi_fix_group_check) module retrieve latest PTF group information from PSP server.
...
def get_psp_group_info():
    ...
    response = AnsibleModule.module_utils.urls.open_url(PSP_URL, context=context)
    ...
    for group in groups:
        ...
        number = group.getElementsByTagName("number")[0].childNodes[0].data
