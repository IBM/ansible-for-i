...
- Dependencies on <b>non-IBM i Ansible server / control node</b>
  ...
  * <b>Ansible core v2.15 to v2.18</b>
...
- Dependencies on <b>IBM i Ansible server / control node</b>
  * <b>Python v3.9 or Python v3.13</b>
    These are the only levels of python provided through the IBM i Open Source Software packages.

  * <b>Ansible core v2.15 or v2.18</b>
    - Ansible core v2.15 requires Python 3.9 on the Ansible control node.
